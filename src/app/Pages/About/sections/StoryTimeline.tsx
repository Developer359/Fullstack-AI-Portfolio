...
import { careerData, aboutTranslations } from '../data/aboutData';
    ...
    <section className="space-y-6 pt-4">
      ...
      <div className="space-y-1">
        <h2 className="text-xl font-bold font-sans text-neutral-900 dark:text-neutral-50 flex items-center gap-2">
          <Briefcase size={19} className="text-neutral-700 dark:text-neutral-300" />
                  ...
                  >
                    <div className="pl-4 sm:pl-[72px] pr-2 pt-4 pb-1 space-y-3">
                      ...
                      <ul className="space-y-2">
                        {item.bullets[lang].map((bullet, bulletIdx) => (
                          <motion.li
                            key={bulletIdx}
