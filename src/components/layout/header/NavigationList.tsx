      ...
      {navigationItems.map((item) => {
        ...
        return (
          <button
            ...
            className={`w-[calc(100%-1.5rem)] lg:ml-4 flex items-center justify-between px-3 rounded-lg text-base transition-all duration-150 group relative select-none cursor-pointer ${isSidebar
                ? isActive
          ...
          >
            ...
            {isActive && (
              <motion.span
                ...
                className={`absolute inset-0 rounded-xl z-0 ${isSidebar
